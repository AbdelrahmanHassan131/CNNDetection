"""
Comprehensive Evaluation Script for WaveletsPacketsScratch_128 Model
...
class EvaluationOptions:
    ...
    def __init__(self, dataroot, checkpoint_path, checkpoint_dir, name, epoch='latest'):
        ...
        self.compute_wavelets = True  # Tell dataloader to compute wavelets
...
def print_metrics_summary(metrics):
    ...
    print("\n" + "="*60)
    print("EVALUATION METRICS SUMMARY - WaveletsPacketsScratch_128")
    print("="*60)
...
def main():
    parser = argparse.ArgumentParser(description='Evaluate WaveletsPacketsScratch_128 model')
    parser.add_argument('--dataroot', type=str, required=True,
                       help='Path to validation dataset (containing fake and real folders)')
    parser.add_argument('--checkpoint', type=str, required=True,
                       help='Path to model checkpoint file')
    parser.add_argument('--name', type=str, default='wavelet_experiment',
