"""
Wavelet Packet CNN Trainer - Original Wolter et al. 2022 Architecture
No modifications - exactly as described in the paper
"""
...
class WaveletPacketTrainer(BaseModel):
    """
    ...
    def name(self):
        return 'WolterWaveletPacket2022_Original'
    
    def __init__(self, opt):
        super(WaveletPacketTrainer, self).__init__(opt)
