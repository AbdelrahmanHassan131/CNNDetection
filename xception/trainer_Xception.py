"""
Trainer for Xception model - inherits from networks/base_model.py
"""
import sys
import os

# Add parent directory to path to import from networks
...
class TrainerXception(BaseModel):
    """Trainer class for Xception binary classification"""
    
    def name(self):
        return 'TrainerXception'

    def __init__(self, opt):
        super(TrainerXception, self).__init__(opt)
